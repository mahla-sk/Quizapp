...
import kotlinx.android.synthetic.main.activity_quiaz_question.*

class QuiazQuestion : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_quiaz_question)

        mQuestionList=Constants.getQuestionList()
        setQuestion()
                    ...
                    if (mSelectedOptionPosition==0){
                        when{
                            mCurrentPosition<=mQuestionList!!.size->{
                                ...
                                Toast.makeText(this,"you have complited the quiz",Toast.LENGTH_SHORT).show()
                                val intent=Intent(this,ResaultActivity::class.java)
                                intent.putExtra("res",(10-res).toString())
